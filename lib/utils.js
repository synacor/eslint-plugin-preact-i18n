...
const _require = require('eslint/lib/ast-utils'),
      createGlobalLinebreakMatcher = _require.createGlobalLinebreakMatcher;
...
exports.isDisallowedTextNode = ({
  ...
  if (!markupNodeNameRE) return text; //verify the offending node is not contained within an i18n tag that allows markup for fallback
